  ...
  "tickets": [
    {
      ...
      "status": "complete",
      "constraints_satisfied": ["bcrypt-verification", "no-plaintext"],
      "implementation": {
        "files": ["src/auth/login.ts", "src/auth/password.ts"],
    ...
    },
    {
      ...
      "status": "complete",
      "constraints_satisfied": ["rate-limiting"],
      "implementation": {
        "files": ["src/middleware/rate-limit.ts"],
    ...
    },
    {
      ...
      "status": "in-progress",
      "constraints_satisfied": ["csrf-protection"],
      "implementation": {
    ...
    },
    {
      ...
      "status": "complete",
      "constraints_satisfied": ["rs256-signing", "configurable-expiration"],
      "implementation": {
        "files": ["src/auth/token.ts", "src/auth/keys.ts"],
